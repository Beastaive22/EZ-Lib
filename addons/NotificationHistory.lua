...
function NotifHistory:Bind(library, window, opts)
    ...
    local main = window and window._main
    ...
    -- was drawn on top of the search field.
    local searchBar = header and header:FindFirstChild("EZSearchBar")
    if searchBar then
